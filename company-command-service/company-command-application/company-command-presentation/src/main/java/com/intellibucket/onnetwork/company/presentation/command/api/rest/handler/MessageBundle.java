...
public class MessageBundle {
    ...
    private static final String FAIL_MESSAGE_BUNDLE_PATH = "message/fail/company_fail_messages.json";
    private static final String SUCCESS_MESSAGE_BUNDLE_PATH = "message/success/company_success_messages.json";
